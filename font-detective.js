...
(function(exports) {
  ...
  someCommonFontNames = "Aptos Mono,Consolas,SF Mono,Monaco,Menlo,Courier New,Lucida Console,Andale Mono,DejaVu Sans Mono,Meslo LG,Input Mono,Operator Mono,Dank Mono,MonoLisa,Berkeley Mono,Commit Mono,Comic Code,PragmataPro,APL2741,APL385 Unicode,Geist Mono".split(",").sort();
  testedFonts = [];
